   ...
   // const data = []
    ...
    return(
        ...
        <div className="card-body">
          ...
          {this.props.delete? (<svg onClick={this.handleDelete} xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" className="bi bi-trash" viewBox="0 0 16 16">
