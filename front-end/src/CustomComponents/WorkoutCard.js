    ...
    return(
        ...
        <div className="card-body">
          ...
          <ul className="list-group list-group-flush">
            { exercises.length>0 ? exercises.map((e,id) => (
          ...
          {this.props.delete? (<svg style={{cursor:'pointer'}} onClick={this.handleDelete} xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="#000000" className="bi bi-trash" viewBox="0 0 16 16">
