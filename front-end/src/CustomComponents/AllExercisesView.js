    ...
    return(
      <div className='container'>
        ...
        <div className='row'>
            ...
            {data.length > 0 ?
                    data.map((d, id) => {            
                return (<div key={id} className="card col-8 col-sm-4 col-md-4 col-lg-3" style={{ margin: '1rem', border: '1px solid #ddd', borderRadius: '8px', boxShadow: '0 4px 8px rgba(0,0,0,0.1)' }}>
                ...
                <svg onClick={()=>{this.handleDelete(id,d.id)}} xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-trash mx-1" viewBox="0 0 16 16">
