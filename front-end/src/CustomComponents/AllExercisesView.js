...
class AllExercisesView extends React.Component {
      ...
      >
          ...
          <div>
            ...
            ></iframe>
                ...
                <svg onClick={()=>{this.handleDelete(d.id)}} xmlns="http://www.w3.org/2000/svg" width="16" height="16" fillRule="currentColor" className="bi bi-trash mx-1" viewBox="0 0 16 16">
                <path d="M5.5 5.5A.5.5 0 0 1 6 6v6a.5.5 0 0 1-1 0V6a.5.5 0 0 1 .5-.5m2.5 0a.5.5 0 0 1 .5.5v6a.5.5 0 0 1-1 0V6a.5.5 0 0 1 .5-.5m3 .5a.5.5 0 0 0-1 0v6a.5.5 0 0 0 1 0z"/>
                <path d="M14.5 3a1 1 0 0 1-1 1H13v9a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2V4h-.5a1 1 0 0 1-1-1V2a1 1 0 0 1 1-1H6a1 1 0 0 1 1-1h2a1 1 0 0 1 1 1h3.5a1 1 0 0 1 1 1zM4.118 4 4 4.059V13a1 1 0 0 0 1 1h6a1 1 0 0 0 1-1V4.059L11.882 4zM2.5 3h11V2h-11z"/>
                </svg>
                {
                  d.is_favorite===1 ? (
                    <svg xmlns="http://www.w3.org/2000/svg"  onClick={()=>{this.toggleFavorite(id,d.id, d.is_favorite)}} width="16" height="16" fillRule="currentColor" className="bi bi-heart-fillRule" viewBox="0 0 16 16">
                  <path fillRule="evenodd" d="M8 1.314C12.438-3.248 23.534 4.735 8 15-7.534 4.736 3.562-3.248 8 1.314"/>
                </svg>
                  ) : (
                <svg onClick={()=>{this.toggleFavorite(id,d.id, d.is_favorite)}} xmlns="http://www.w3.org/2000/svg" width="16" height="16" fillRule="currentColor" className="bi bi-heart mx-1" viewBox="0 0 16 16">
  ...
  <div className="dropdown-menu dropdown-menu-left mt-1" id="exercisesDropdown" aria-labelledby="dropdownMenuButton" >
        <div className="container">
                <h5>Add Exercise</h5>
