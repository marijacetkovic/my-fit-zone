        ...
        return (
            <div className="px-4 py-5 my-5 text-center">
                ...
                <div className="col-lg-6 mx-auto">
                    <p className="lead mb-4">Your fitness journey starts here. MyFitZone helps you track, improve, and achieve your fitness goals with ease.</p>
                    <p className="lead mb-4">Whether you're a beginner or a fitness enthusiast, MyFitZone provides tools and insights to support your progress.</p>
                </div>
            </div>
        );
    }
